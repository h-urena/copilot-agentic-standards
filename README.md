...
| `.github/prompts/workflows/` | `.github/prompts/workflows/` | Workflow agent prompts |
...
Copilot Chat with `#<prompt-name>` or via the Copilot agent mode. Prompts are organised into three
subfolders: `workflows/`, `scaffolds/`, and `personas/`.
...
**Scaffold prompts** (`.github/prompts/`)

| Prompt | Purpose |
|--------|---------|
| `scaffold-crud-api.prompt.md` | Scaffold a CRUD API: routes, models, validation, service layer, tests |
| `scaffold-auth.prompt.md` | Wire auth: identity provider, middleware, route protection, audit logging |
| `scaffold-database.prompt.md` | Set up database: connection, ORM, migrations, seeding, health check |
| `scaffold-frontend.prompt.md` | Scaffold frontend component: structure, a11y, state, forms, tests |
...
> `.github/prompts/workflows/governance.prompt.md`. Never push directly to `main`.
...
.github/
  ...
  prompts/
    workflows/         Workflow agent prompts (governance, implement-feature, fix-bug, …)
